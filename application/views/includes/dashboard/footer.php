...
<!-- FAQ window	-->
<div id="initfaq" class="zoom-anim-dialog mfp-hide dialog-with-tabs" style="max-width: 40%;margin: 0 auto;">
	...
	<div class="sign-in-form">
		<div class="popup-tabs-container">
			<div class="popup-tab-content" id="chat">
				<div class="welcome-text">
					<h3 style="color:white;">Please Tell use more about your problem!</h3>
				</div>
				<form method="get" action="<?php echo base_url(); ?>search">
					<div class="input-with-icon-left">
						<i class="icon-material-baseline-mail-outline"></i>
						<input type="text" class="input-text with-border" name="keyword" placeholder="Your query" required/>
					</div>
					<button class="button full-width button-sliding-icon ripple-effect" type="submit">Get Help <i class="icon-material-outline-arrow-right-alt"></i></button>
				</form>
			</div>
		</div>
	</div>
